...
# Create Optuna Study
n_trials = 50
study = optuna.create_study(study_name='attentiveFP_v01_dropout_tuning', direction='minimize')
...
study_file = '../deep_learning_outputs/tuning_logs/attentiveFP_dropout_tuning.csv'
