...
# save trained model
torch.save(model, '../deep_learning_outputs/trained_models/attentiveFP_v01_minmaxscaler_logP.pt')
...
plot_history(
    ...
    figsize=(16, 8),
    file='../deep_learning_outputs/figures/train_history_attentiveFP_v01_minmaxscaler_logP.png'
)
...
training_lod_df.to_csv(
    '../deep_learning_outputs/training_logs/train_history_attentiveFP_v01_minmaxscaler_logP.csv',
    index=False,
    header=True
)
...
test_metrics_csv = '../deep_learning_outputs/model_evaluation/attentiveFP_test_evaluation_v01_minmaxscaler_logP.csv'
...
npz_file = '../deep_learning_outputs/model_evaluation/attentiveFp_predicted_values_v01_minmaxscaler_logP.npz'
...
correlation_file = f'../deep_learning_outputs/model_evaluation/attentiveFP_correlation_plot_v01_minmaxscaler_logP.png'
