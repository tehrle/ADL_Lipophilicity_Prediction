...
# save trained model
torch.save(model, '../deep_learning_outputs/trained_models/basic_gat_v02_leaky_relu_v02.pt')
...
plot_history(
    ...
    figsize=(16, 8),
    file='../deep_learning_outputs/figures/train_history_basic_gat_v02_leaky_relu_v02.png'
)
...
training_lod_df.to_csv(
    '../deep_learning_outputs/training_logs/train_history_basic_gat_v02_leaky_relu_v02.csv',
    index=False,
    header=True
)
...
test_metrics_csv = '../deep_learning_outputs/model_evaluation/basic_gat_test_evaluation_v02_leaky_relu_v02.csv'
...
npz_file = '../deep_learning_outputs/model_evaluation/basic_gat_predicted_values_v02_leaky_relu_v02.npz'
...
correlation_file = f'../deep_learning_outputs/model_evaluation/basic_gat_correlation_plot_v02_leaky_relu_v02.png'
