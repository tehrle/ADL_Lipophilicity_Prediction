...
class SimpleGCN(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, edge_dim):
        ...
        self.edge_nn1 = Sequential(
            Linear(in_features=edge_dim, out_features=hidden_channels),
            ReLU(),
            Linear(in_features=hidden_channels, out_features=hidden_channels * hidden_channels)
        )
        self.conv1 = NNConv(
...
# save trained model
torch.save(model, '../deep_learning_outputs/trained_models/basic_gcn_v04.pt')
...
plot_history(
    ...
    figsize=(16, 8),
    file='../deep_learning_outputs/figures/train_history_basic_gcn_v04.png'
)
...
training_lod_df.to_csv(
    '../deep_learning_outputs/training_logs/train_history_basic_gcn_v04.csv',
    index=False,
    header=True
)
...
test_metrics_csv = '../deep_learning_outputs/model_evaluation/basic_gcn_test_evaluation_v04.csv'
...
npz_file = '../deep_learning_outputs/model_evaluation/basic_gcn_predicted_values_v04.npz'
...
correlation_file = f'../deep_learning_outputs/model_evaluation/basic_gcn_correlation_plot_v04.png'
